...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` //JWT token of the logged user
}
...
type IsAdminRequest struct {
	...
	UserId int64 `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Id to check
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` //Is user an admin
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x14, 0x69, 0x63, 0x65, 0x6c, 0x6f, 0x63, 0x61, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31,
